...
public class OAP_2041POM_TRY {
	...
	@Test
	public void test() {
		final String SCREENSHOTPATH = System.getProperty("user.dir") + "\\Screenshots\\test\\"; // use 'Temp' directory if you do not want to override the old screenshots
		final String EXCELFILEPATH = System.getProperty("user.dir") + "\\Test Reports\\test.xlsx";
		String picPath = "";
		...
		WriteDataToExcel.writeToExcelFileTest(this.statusInfo, EXCELFILEPATH);
	    System.out.println("**************************");
