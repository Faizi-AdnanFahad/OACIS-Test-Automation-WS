...
public class LandingPageModel {
	...
	public String BrowserWindowHandle;  // stores the original window. Useful to shift back to it when changing the focus of the window to drop-down list or similar things.
	...
	public LandingPageModel(WebDriver driver)
	{
		...
		this.Driver = driver;
		BrowserWindowHandle = driver.getWindowHandle();
	}
...
//	public QueuePageModel ClickApplicationLink() {
//		GetQueueLnk().click();
//		return new QueuePageModel(Driver);
//	}
