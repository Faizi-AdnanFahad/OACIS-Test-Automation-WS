...
public class ClientInformationModel implements POMPage {
	...
	public ClientInformationModel TakeScreenShot() {
	...
	public ClientInformationModel(WebDriver driver)
	{
		DriverFactory.WaitForPageLoad(driver);
		this.Driver = driver;
	}

	public ClientInformationModel FillQueryTxtFld(String text)
	{
	...
	public ClientInformationModel FillOAPClientNumberTxtFld(String text)
	{
	...
	public ClientInformationModel FillIIO_TransitionCodeTxtFld(String text)
	{
	...
	public ClientInformationModel FillRegistrationDateTxtFld(String text)
	{
	...
	public ClientInformationModel FillLastNameTxtFld(String text)
	{
	...
	public ClientInformationModel FillFirstNameTxtFld(String text)
	{
	...
	public ClientInformationModel FillMiddleNameTxtFld(String text)
	{
	...
	public ClientInformationModel FillDob_txtDateTxtFld(String text)
	{
	...
	public ClientInformationModel FillDoNInvitationDate_txtDateTxtFld(String text)
	{
	...
	public ClientInformationModel FillIIO_InvitationSentDateTxtFld(String text)
	{
	...
	public ClientInformationModel FillIIO_DossierSentDateTxtFld(String text)
	{
	...
	public ClientInformationModel FillConsentProviderNameTxtFld(String text)
	{
	...
	public ClientInformationModel FillDateFieldNoTransferConfirmedTxtFld(String text)
	{
...
//		return new Place_Holder(Driver);
//	}
	private ClientInformationModel SelectOptionGeneral_LockStatusSelect(WebElement selectElement, WebDriver driver, String originalWindow, String optionText) {
	...
	private ClientInformationModel SelectOptionGeneralTitleSelect(WebElement selectElement, WebDriver driver, String originalWindow, String optionText) {
		Actions action = new Actions(driver);////Create an object to store a chain of keypresses
		selectElement.click();////cause the select element to be highlighted
		Select foundSelect = new Select(selectElement);////convert webelement to select element
		List<WebElement> selectOptions = foundSelect.getOptions();////get select options
	...
	private ClientInformationModel SelectOptionGeneralGenderSelect(WebElement selectElement, WebDriver driver, String originalWindow, String optionText) {
		Actions action = new Actions(driver);////Create an object to store a chain of keypresses
		selectElement.click();////cause the select element to be highlighted
		Select foundSelect = new Select(selectElement);////convert webelement to select element
		List<WebElement> selectOptions = foundSelect.getOptions();////get select options
